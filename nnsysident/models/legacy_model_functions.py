...
from neuralpredictors.layers.cores import SE2dCore, Stacked2dCore, TransferLearningCore
...
class MultipleZeroInflatedReadout(MultiReadoutSharedParametersBase):
...
def se2d_fullgaussian2d(
    ...
    readout = MultipleZeroInflatedReadout(
    ...
    model = FiringRateEncoder(core=core, readout=readout, modulator=modulator, shifter=shifter, elu_offset=elu_offset)
...
def se2d_pointpooled(
    ...
    model = FiringRateEncoder(core=core, readout=readout, elu_offset=elu_offset)
