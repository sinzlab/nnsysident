...
for experiment_name in ['Real, Direct, se2d_fullSXF, 4-set, last 1000 neurons',
...
# for experiment_name in ['Real, core_transfer (best), share_features=False, se2d_fullSXF, 4-set -> 4-set',
#                         'Real, core_transfer (best), share_features=True, se2d_fullSXF, 4-set -> 4-set',
#                         'Real, core_transfer (sameNI), share_features=False, se2d_fullSXF, 4-set -> 4-set',
#                         'Real, core_transfer (sameNI), share_features=True, se2d_fullSXF, 4-set -> 4-set'
#                         ]:
#
