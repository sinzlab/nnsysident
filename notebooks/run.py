...
# for experiment_name in ['Real, Direct, random 128, se2d_fullgaussian2d, 20457-5-9',
...
# for experiment_name in ['Real, core_transfer (animal) no cortex, se2d_fullgaussian2d, 11-S -> 20457-5-9',
#                         'Real, core_transfer (animal), se2d_fullgaussian2d, 1-set -> 20457-5-9',
#                         'Real, core_transfer (animal), se2d_fullgaussian2d, 11-S -> 20457-5-9',
...
for neuron_n in [3625]: # 50, 500, 1000, 3625    ,
    for image_n in [4399]: ###### 50, 200, 500, 1000, 2500, 4399
        try:
            print('--------------------------------------')
            print('Image_n = {}'.format(image_n))
            ...
            model_config_auto = dict(
                gamma_readout={"type": "range", "bounds": [10000., 100000.], "log_scale": True},
                #share_features={"type": "choice", "values": [True, False]}
            )
...
#                         "hidden_kern": 13,
#                         'normalize': False,
#                         'transfer_state_dict': 'f6cf96b1ed6bdbec448acbd2742f1c05-4gaussian.pth.tar',
#                         }
#         print(model_fn)
#         print(model_config)
#         model_config_auto = dict(
#             gamma_readout={"type": "range", "bounds": [0.001, 0.1], "log_scale": True},
#             share_features={"type": "choice", "values": [True, False]},
#         )
#
#         trainer_fn = 'nnsysident.training.trainers.standard_trainer'
