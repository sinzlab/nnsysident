...
#             init_noise={"type": "range", "bounds": [1e-5, 1e3], "log_scale": True},
#         )
#
#
...
# for neuron_n in [1000]: # 50, 500, 1000, 3625    ,
...
#     model_config = {'gamma_input': 1., "input_kern": 15, "hidden_kern": 13, "share_features": True,
#     }
#     model_config_auto = dict(
